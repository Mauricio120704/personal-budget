...
//   };
// }
// // Además, permite que la función createMovement() reciba los valores ya extraídos y listos para procesar.

// /* Esta parte sirve para: 
// 1. Crea y registra un nuevo movimiento financiero en la lista.
// 2. Se asegura de que los datos sean correctos antes de agregarlos.
// 3. Actualiza la interfaz gráfica automáticamente al agregar una nueva transacción.
// */
...
// // 2 -> Egreso
// /*
// Esta parte es la estructura base para representar cada transacción (ingreso o gasto).
// Nos permite manejar cada movimiento como un objeto con sus propias propiedades.
// */
...
//   const newRow = `
//     <tr class="hover:${colorFondo} ${colorFondo}/30 transition-colors duration-200"> // Construye una fila (<tr>) con los datos de la transacción
...
// /* 
//   Evita datos incorrectos antes de agregar una transacción.
// Mejora la experiencia de usuario al dar mensajes de error claros.
// */
